...
public class TvShowDs extends PageKeyedDataSource<Integer, TvShow> {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, TvShow> callback) {
        ...
        ApiClient.getInstance().getApi().getTvShowList(BuildConfig.MovieAPIKey, "en-US", FIRST_PAGE)
    ...
    @Override
    public void loadBefore(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, TvShow> callback) {
        networkState.postValue(NetworkState.LOADING);
        ApiClient.getInstance().getApi().getTvShowList(BuildConfig.MovieAPIKey, "en-US", params.key)
                .enqueue(new Callback<TvShowList>() {
                    @Override
                    public void onResponse(Call<TvShowList> call, Response<TvShowList> response) {
                        if (response.isSuccessful()) {
